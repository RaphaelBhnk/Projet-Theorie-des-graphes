...
void Svgfile::addLine(double x1, double y1, double x2, double y2,double ep, std::string color)
{
    m_ostrm << "<line "
            << attrib("x1", x1)
            << attrib("y1", y1)
...
void Svgfile::addText2(double x, double y, double val, std::string color)
{
    std::ostringstream oss;
    oss << val;
...
void Svgfile::addText3(double x, double y, int val, std::string color)
{
    std::ostringstream oss;
    oss << val;
    addText(x, y, oss.str(), color);
...
void Svgfile::addText4(double x, double y, float val, std::string color)
{
    std::ostringstream oss;
    oss << val;
    addText(x, y, oss.str(), color);
...
void Svgfile::addgradient(double x, double y, double rx, double ry, std::string colorbegin, std::string colorend, std::string grad1)
{
    m_ostrm << "<defs>\n<linearGradient "
            << attrib("id", grad1)
            << attrib("x1", "0%")
